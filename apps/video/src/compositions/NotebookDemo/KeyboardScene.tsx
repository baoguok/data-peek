...
const FocusedCell: React.FC<FocusedCellProps> = ({
  focusOffset,
  label,
  isFocused,
}) => {
  ...
  const ringPulse = interpolate((frame % 60) / 60, [0, 0.5, 1], [0.6, 1, 0.6]);
          ...
          <Sequence from={5} layout="none">
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <FocusedCell
                ...
                label="Cell 1"
                isFocused={focusedCellIndex === 0}
              />
              <FocusedCell
                focusOffset={-focusOffset + 80}
                label="Cell 2"
                isFocused={focusedCellIndex === 1}
              />
            </div>
          </Sequence>
