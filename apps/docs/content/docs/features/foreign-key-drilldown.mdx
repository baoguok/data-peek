...
<Callout type="tip">
  This is especially useful for debugging relational data. Start from an order,
  click the customer_id to see the customer, then click their billing_address_id
  to see the address, all without writing a JOIN.
</Callout>
