...
New in v0.27: let the [AI assistant](/docs/features/ai-assistant) build your widgets. With the **Claude Code (local CLI)** provider and the [MCP server](/docs/features/mcp-server) enabled, everything is _grounded_ — the assistant explores your schema and writes verified SQL against your live data.
...
<video
  ...
  muted
  playsInline
  poster="/images/ai-dashboard-widget-poster.png"
  style={{ width: '100%', borderRadius: '12px', border: '1px solid rgba(128,128,128,0.25)' }}
>
  <source src="/videos/ai-dashboard-widget.mp4" type="video/mp4" />
  Your browser doesn't support embedded video —
  [download the walkthrough](/videos/ai-dashboard-widget.mp4).
</video>
...
<video
  ...
  muted
  playsInline
  poster="/images/ai-generate-dashboard-poster.png"
  style={{ width: '100%', borderRadius: '12px', border: '1px solid rgba(128,128,128,0.25)' }}
>
  <source src="/videos/ai-generate-dashboard.mp4" type="video/mp4" />
  Your browser doesn't support embedded video —
  [download the walkthrough](/videos/ai-generate-dashboard.mp4).
</video>
